...
describe("removal on the captured tray", () => {
  it.each([
    { file: "edge-dice-3-6-6.png", angle: 45, values: [3, 6, 6],
      inside: [[80, 180], [320, 220], [500, 250], [300, 145], [393, 105]],
      outside: [[320, 340], [600, 300], [20, 300], [200, 30], [30, 100]] },
    { file: "center-dice-2-3-5.png", angle: 70, values: [2, 3, 5],
      inside: [[150, 200], [400, 200], [320, 340], [264, 176], [314, 230], [320, 115]],
      outside: [[320, 356], [550, 330], [600, 300], [20, 300], [200, 50]] },
    ...
    const dice = detectDiceOpenCv(cv, frame, angle);
    expect(dice.map((die) => die.value)).toEqual(values);
